    ...
    <main className="mx-auto max-w-md space-y-8 px-4 py-8">
      ...
      <section id="operator" className="scroll-mt-4 space-y-4">
        ...
        <p className="rounded-lg bg-amber-50 px-3 py-2 text-xs text-amber-700">
          🚌 가려는 지구가 <b>아직 버스를 안 올렸다면</b> — 조회 결과의 ‘대기큐에 신청 넣기’로{" "}
          <b>버스 미배정 대기 신청</b>을 걸어둘 수 있어요. 반대로 우리 지구를 기다리는 신청은
          대시보드의 <b>‘버스 미배정 대기큐’</b>에 떠요. 버스를 올린 뒤 거기서 차량으로 배정하면
          이후 승인·입금은 일반 신청과 동일해요.
        </p>
      </section>
      ...
      <section id="student" className="scroll-mt-4 space-y-4">
        ...
        <p className="rounded-lg bg-blue-50 px-3 py-2 text-xs text-blue-700">
          🚌 가려는 지구에 <b>아직 버스가 없다면</b> — 조회 결과의 ‘대기큐에 신청 넣기’로 대기
          신청을 걸어둘 수 있어요. 버스가 생기면 그 지구 간사가 배정해 주고, 진행 상황은 홈의
          신청 카드에서 확인돼요.
        </p>
        <p className="rounded-lg bg-amber-50 px-3 py-2 text-xs text-amber-700">
